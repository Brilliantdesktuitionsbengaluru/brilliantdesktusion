...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Brilliant Desk Tuitions — Classes 1 to 10, Bengaluru" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Brilliant Desk Tuitions — Classes 1 to 10" },
      {
        ...
        content: "State, CBSE and ICSE tuition for Classes 1-10 with free notes, PYQs and model papers.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      {
        name: "google-site-verification",
        content: "Mjs7PugzTes9lm6FGrsmZkh1i0lf8GkSr4UzYLVyI-Q",
      },
    ],
    links: [
